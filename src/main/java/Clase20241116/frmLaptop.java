...
public class frmLaptop extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mecanico ", "Convencional ", " " }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gris ", "Blanco ", "Negro", " " }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "HP", "DELL", "PAVIILON", "MSI", " " }));

        jButton1.setText(" Agregar");

        jButton2.setText("Cancelar");

        jLabel6.setText("REGISTRO DE LAPTOPS");
