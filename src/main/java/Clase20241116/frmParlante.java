...
public class frmParlante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Registro de parlantes ");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gris ", "Negro ", "Blanco ", " " }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "JBL", " ", " " }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "J04", "B06" }));

        jButton1.setText("Agregar");

        jButton2.setText("Cancelar");

        jLabel6.setText("REGISTRO DE PARLANTES");
